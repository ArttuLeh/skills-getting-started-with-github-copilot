...
activities = {
    ...
    "Soccer Team": {
        ...
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "nina@mergington.edu", "leo@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Pickup games, skills practice, and intramural tournaments",
    ...
    "Science Olympiad": {
        "description": "Team-based science competitions covering multiple disciplines",
